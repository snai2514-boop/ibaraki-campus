...
object ICalExporter {
    ...
    fun generateICalContent(
        ...
        require(timeZoneId in setOf("Asia/Shanghai", "Asia/Tokyo")) { "Unsupported timetable time zone" }
        val zoneOffset = if (timeZoneId == "Asia/Tokyo") "+0900" else "+0800"
        ...
        sb.appendLine("X-WR-TIMEZONE:$timeZoneId")
        ...
        sb.appendLine("TZOFFSETFROM:$zoneOffset")
        sb.appendLine("TZOFFSETTO:$zoneOffset")
        ...
        courses.forEach { course ->
            ...
            weekList.forEach { week ->
                ...
                sb.appendLine("DTSTART;TZID=$timeZoneId:${eventDateStr}T$startTimeStr")
                sb.appendLine("DTEND;TZID=$timeZoneId:${eventDateStr}T$endTimeStr")
    ...
    fun exportAndShare(
        ...
        try {
            val icsContent = generateICalContent(courses, semesterStartDate, totalWeeks, periodTimes, timeZoneId)
