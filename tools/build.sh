...
node --test Tests/core.test.cjs Tests/academic.test.cjs Tests/theme-pack.test.cjs
...
(cd build/package && zip -qry ../dist/CampusAssistant-1.0.82-unsigned.ipa Payload)
