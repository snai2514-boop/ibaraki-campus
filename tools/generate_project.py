...
appconfigs=configs('app',dict(common,PRODUCT_NAME='"$(TARGET_NAME)"',PRODUCT_BUNDLE_IDENTIFIER='com.campusassistant.ibaraki.ios',INFOPLIST_FILE='CampusAssistant/Info.plist',ASSETCATALOG_COMPILER_APPICON_NAME='AppIcon',ASSETCATALOG_COMPILER_ALTERNATE_APPICON_NAMES='"Sky Night"'))
